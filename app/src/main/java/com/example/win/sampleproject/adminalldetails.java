...
public class adminalldetails extends AppCompatActivity{
    private Button bt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter= ArrayAdapter.createFromResource(adminalldetails.this,
        ...
        myearspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(adminalldetails.this,"Please select any year",Toast.LENGTH_LONG).show();
            }
        });

        ArrayAdapter<CharSequence> adapter2= ArrayAdapter.createFromResource(adminalldetails.this,
        ...
        msectionspinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(adminalldetails.this,"Please select any section",Toast.LENGTH_LONG).show();

            }
        });

        ArrayAdapter<CharSequence> adapter3= ArrayAdapter.createFromResource(adminalldetails.this,
        ...
        mtypespinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(adminalldetails.this,"Please select any type",Toast.LENGTH_LONG).show();
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i=new Intent(adminalldetails.this,adminViewall.class);
